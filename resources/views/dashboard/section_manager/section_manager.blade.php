...
<div class="container mx-auto p-6">
    ...
    <a href="{{ Auth::user()->hasRole(['admin']) ? route('admin.drivers.create') : route('section_manager.drivers.create') }}"
       class="btn btn-primary fixed-add-driver">
       ➕ Add Driver
    </a>

    {{-- Search Bar --}}
    <form action="{{ route('section_manager.requests.search') }}" method="GET" class="mb-6 flex justify-center mt-6">
...
@media (max-width: 768px) {
    ...
    .fixed-add-driver { position: static; margin-bottom: 1rem; transform: none; width: 100%; text-align: center; }
}
</style>
@endsection
