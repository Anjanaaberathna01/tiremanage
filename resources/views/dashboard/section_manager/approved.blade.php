...
<div class="container mx-auto p-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3 class="mb-0"><i class="bi bi-check2-circle me-2"></i> Approved Requests</h3>
    <div class="w-auto">
  ...
  <ul class="requests-list list-unstyled" id="approvedList">
          ...
          <div class="request-info">
            <div class="request-header d-flex justify-content-between align-items-center">
              ...
              <div class="small text-muted">
                <i class="bi bi-calendar3 me-1"></i>{{ optional($approval->updated_at)->format('Y-m-d H:i') ?? '-' }}
              </div>
            </div>
...
.request-card { border:1px solid #e5e7eb; border-left:4px solid #16a34a; border-radius:.75rem; background:#fff; }
.request-card:hover { transform:translateY(-2px); box-shadow:0 12px 18px rgba(0,0,0,.08) !important; }
.request-header { font-size:1.05rem; font-weight:600; color:#0a6848; }
