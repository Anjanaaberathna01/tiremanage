            ...
            <li class="request-card">
                <div class="request-content">
                    ...
                    <div class="request-actions">
                        <a href="{{ route('mechanic_officer.requests.edit', $req->id) }}" class="edit-btn">
                            ✏️ Edit
                        </a>
                    </div>
                </div>
...
/* Info */
.request-header { font-size: 1.1rem; font-weight: 600; color: #065f46; margin-bottom: 0.3rem; }
.request-vehicle { font-size: 1rem; margin-bottom: 0.6rem; color: #374151; }
