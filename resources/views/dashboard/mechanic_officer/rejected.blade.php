...
@section('title', 'Rejected Tire Requests')

@section('content')
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-bold text-red-600 mb-6">❌ Rejected Tire Requests</h2>
            ...
            <tbody>
                @foreach($requests as $request)
                    <tr class="border-b hover:bg-gray-100 transition">
                        ...
                        <td class="px-4 py-2 text-red-700 font-semibold">{{ ucfirst($request->status) }}</td>
                        <td class="px-4 py-2">
